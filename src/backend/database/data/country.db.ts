...
export const CountryDbStructure = {
  ...
  attributes: {
    ...
    guid: {
      type: DataTypes.INTEGER,
      allowNull: false,
      unique: {name: 'unique_country_guid', msg: 'The country GUID must be unique'},
      comment: 'GUID automatically generated'
    },
    code: {
      type: DataTypes.INTEGER,
      allowNull: false,
      unique: {name: 'unique_country_code', msg: 'The country code must be unique'},
      comment: 'International code (e.g. 237 for Cameroun)',
    },
    iso: {
...
export default CountryDbStructure;
