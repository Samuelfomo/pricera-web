...
export default class CountryModel extends BaseModel {
   ...
   */
  protected async listAllByTimezone(timezone: string): Promise<any[]> {
    return await this.findAll(this.db.tableName, { [this.db.timezone]: timezone });
  }
  ...
  protected async create(): Promise<void> {
    ...
    console.log(`🌍 Pays créé - ISO: ${this.iso} | Code: ${this.code} | GUID: ${this.guid}`);
